 ...
 * @author mahmo
 */
public class App_Admin_Edit_Trip extends javax.swing.JFrame {

    /**
     * Creates new form App_Admin_Edit_Trip
     */
    public App_Admin_Edit_Trip() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String trip_date = jComboBox1.getSelectedItem().toString() + "-" + jComboBox8.getSelectedItem().toString() + "-" + jComboBox5.getSelectedItem().toString()
        ...
        if (DBConnection.isTripExist(tripInfo)) {
            TripInfo tripExtendedInfo = DBConnection.get_trip(tripInfo);
            App_Trip_Admin_Edit_Form form_edit = new App_Trip_Admin_Edit_Form(tripExtendedInfo);
            form_edit.setVisible(true);
        }
        else {
